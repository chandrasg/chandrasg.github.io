...
- *Weibo and Twitter word embeddings for 2012-2018* --- [Dataset](https://forms.gle/q3gn9DzNM5CUzePq9)

---

## Code & Lexica

- *Lexica* (stress, loneliness, and more) --- [GitHub](https://github.com/chandrasg/lexica)
- *CDBN Implementation* --- [GitHub](https://github.com/sharathchandra92/CDBN)
- *Flickr API Downloader* --- [GitHub](https://github.com/sharathchandra92/flickrapi_downloadfavorites)
